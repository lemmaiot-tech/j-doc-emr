...
export const TestTube2: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const Stethoscope: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4.8 2.3A.3.3 0 1 0 5 2a.3.3 0 0 0-.2.3"/><path d="M6.6 4.2A.3.3 0 1 0 6.4 4a.3.3 0 0 0 .2.2"/><path d="M5 2.5a4 4 0 0 0-1 7.8V18a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2v-7.7a4 4 0 1 0-3-7.8Z"/><path d="M8 18v1a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2v-4"/><path d="M12 15h1a2 2 0 0 1 2 2v1"/><circle cx="19" cy="5" r="2"/></svg>
);
...
export const Scissors: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M20 4 8.12 15.88"/><path d="M14.47 14.48 20 20"/><path d="m8.12 8.12 11.88 11.88"/></svg>
);
...
export const CloudOff: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m2 2 20 20"/><path d="M5.87 5.87A7.003 7.003 0 0 0 9 19h8.5a4.5 4.5 0 0 0 1.3-8.73"/><path d="M14.5 14.5A4.5 4.5 0 0 0 18 6.5a4.52 4.52 0 0 0-4-3.23"/><path d="M9.06 9.06A7.003 7.003 0 0 0 9 5a7 7 0 0 0-7 7h.5"/></svg>
);
